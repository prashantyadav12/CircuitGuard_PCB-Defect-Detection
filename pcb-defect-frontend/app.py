...
# CONFIG 
API_BATCH_URL = os.environ.get(
    "BACKEND_URL", "https://circuitguard-pcb-defect-detection-rpv4.onrender.com"
).rstrip("/") + "/detect-batch"
...
st.markdown(
    ...
    <div class="header-container">
        ...
        <div style="
            ...
            text-align:center;
        ">
            <span style="color:#2563eb;font-weight:900;">CircuitGuard – </span>
            <span style="color:#2563eb; font-weight:900;">PCB</span>
            <span style="color:#2563eb;font-weight:900;"> Defect Detection</span>
        </div>
    </div>
    """,
    unsafe_allow_html=True
